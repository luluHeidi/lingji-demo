...
class ModuleLoader {
    ...
    getModuleIdBySubmenu(submenuId) {
        ...
        const mapping = {
            ...
            // 视频作品授权管理
            'full-video-auth': 'module-video-full',
            'short-video-auth': 'module-video-short',
            'ugc-whitelist': 'module-video-ugc',
            'all-catalog': 'module-video-catalog',
    ...
    async loadModule(moduleId) {
        ...
        try {
            ...
            // 加载模块HTML
            const htmlResponse = await fetch(`${modulePath}/index.html`);
